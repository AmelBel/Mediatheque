...
insert into document (id, titre, nombre_Exemplaire, date_Parution) values (1, 'Good', 50, '12-10-16');
insert into document (id, titre, nombre_Exemplaire, date_Parution) values (2, 'True', 40, '01-01-17'); 
insert into document (id, titre, nombre_Exemplaire, date_Parution) values (3, 'Good', 60, '05-08-20');
insert into document (id, titre, nombre_Exemplaire, date_Parution) values (4, 'The planete', 80, '01-01-19'); 
insert into document (id, titre, nombre_Exemplaire, date_Parution) values (5, 'Take care', 70, '01-03-15');
insert into document (id, titre, nombre_Exemplaire, date_Parution) values (6, 'Formidable', 100, '01-01-12'); 
